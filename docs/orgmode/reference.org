...
| Verb | Habitat | Does |
|---+---+---|
| =sitting ISSUE [--assignee NAME] [--cards DIR] [--playbook NAME] [--anyway]= | all | open a sitting: doctor, cards, due, island, playbook, recall, timeline, claim; stops at the first store down; the name defaults to this conversation's holder (=ljos seat=); =--playbook= copies a recipe before recall and holds it until finish or release |
...
| =playbook ISSUE NAME= | pack | bind a recipe to the issue and copy its full body; the name sticks until finish or release |
