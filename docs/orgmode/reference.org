...
| =learn ID --outcome OPTION [--beta B] [--share S]= | tracker, pack | reweigh voters by what turned out right; =--share= is a fixed share of recovery toward one after the step |
