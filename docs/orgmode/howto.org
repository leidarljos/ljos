...
command line the same order is =ljos doctor=, =ljos cards=, =ljos due=,
=ljos search=, =ljos island=, =ljos recall=, =ljos claim=. A claim refused as
busy names the issue you still hold; =ljos complete= finishes it and
=ljos release= hands it back.
