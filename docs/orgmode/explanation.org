...
(doi:10.48550/arXiv.2507.05257) the rows to beat are the retrieval
baselines rather than the memory products, which that benchmark's authors
found behind them. The packset site carries every table and the
