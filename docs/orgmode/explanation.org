...
- Citing a deed names it; the bytes stay in deedar. Citing a deed names it; the bytes stay in the
  deed store.
- The ticket stays open until vissue closes it. The claim graph is
