...
- A finish with status done closes the ticket; a completed node alone leaves it. The claim graph is
...
#+ATTR_HTML: :alt Landfold of the pack: this task's island versus other work :width 100%
[[file:_static/island.svg]]
...
links one step, not one step each. Activation spreads in proportion to
